        ...
        <form id="myform" class="sign_area" autocomplete="off">
            ...
            <div class="regist_m_1">
                <div class="add_regist">
                    <ul>
                        <li class="frame_style"><label class="user_icon"></label><input name="" type="text"  id="username"  onblur="findUsername"/><i></i></li>
                        <li class="frame_style"><label class="password_icon"></label><input name="tbPassword" type="password"   id="password"  class="ywz_zhuce_kuangwenzi1 text_Password"/><i class="tx_password"></i></li>
